...
var mainTractionAxle = 1;  			  	// Eje de tracci�n principal. 0: frontal, 1: trasero, 2: ambos
...
var externalInput = false;				// El coche recibe la entrada de un componente derivado de CarExternalInput. 
										// El componente Debe estar presente. Si no lo est�, el coche no recibir� entrada de ning�n tipo.
var bypassTC = false;
var bypassABS = false;
...
function Update () 
	...
	// Desactivar elementos que no est�n disponibles.
	...
	// Ajustar tractionAxle seg�n hasTractionModes (nota: valores desconocidos asumen 0 - eje fijo)
	...
	switch (hasTractionModes)
		{
		case 1:		// Eje fijo + 4x4. Permitir s�lo eje principal o 4x4
